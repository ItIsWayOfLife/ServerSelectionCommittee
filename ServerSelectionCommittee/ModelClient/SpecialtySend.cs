...
namespace ServerSelectionCommittee
{
    ...
    public class SpecialtySend
    {
        ...
        public static void DataSerializable()
        {
            ...
            using (FileStream fs = new FileStream("SerializableFile/SpecialtySend.xml", FileMode.Create))
            {
        ...
        public static string ReadToXml()
        {
            ...
            using (StreamReader reader = new StreamReader("SerializableFile/SpecialtySend.xml"))
            {
